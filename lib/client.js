  ...
  callbackParams(input) {
    ...
    if (isIncomingMessage) {
      switch (input.method) {
        ...
        default:
          throw new TypeError(`invalid IncomingMessage method. Expected [GET, POST], got ${input?.method}. Input type: ${typeof input}. Input url: ${input?.url}`);
      }
    } else {
      ...
      const tokenset = await this.grant(
        {
          ...
          client_session_state: params.session_state,
        },
